...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default="val_loss",
        choices=["val_loss", "val_group_balanced_accuracy"],
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Checkpoint file name. Defaults to '<artifact-prefix>_best.pt'.",
    )
    parser.add_argument(
        "--artifact-prefix",
        type=str,
...
def main() -> None:
    args = parse_args()
    checkpoint_name = args.checkpoint_name or f"{args.artifact_prefix}_best.pt"
